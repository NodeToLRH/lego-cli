...
const WS_SERVER = '' // TODO : websocket 服务地址
...
class CloudBuild {
  ...
  async prepare() {
    ...
    if (this.prod) {
      ...
      // TODO : 获取OSS文件请求地址
      const ossProject = await axios.get({
        url: '/project/oss',
        params: {
          name: projectName,
          type: projectType,
  ...
  init() {
    return new Promise((resolve, reject) => {
      console.log('CloudBuild init this.git.remote : ', this.git.remote)
      console.log('CloudBuild init this.git.name : ', this.git.name)
      console.log('CloudBuild init this.git.branch : ', this.git.branch)
      console.log('CloudBuild init this.git.version : ', this.git.version)
